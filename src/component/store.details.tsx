    ...
    return (
        <Box sx={{ flexGrow: 1 , display: 'flex', marginTop: '15px', justifyContent:'center'}} >
            <div style={{ width: '230px' , margin: '20px'}}>
                ...
                <div style={{ width: '250px', margin: '5px', textAlign: 'left' , fontSize: '12px'}}>

                    <p><strong>SA</strong> : 20th A main road 2nd Stage Vijaynagar <br /> Mysore 570017 <MdLocationPin/></p>
